...
func TestUpdateShop1(t *testing.T){
	...
	httpposturlCreate := "http://localhost:8080/api/shops/1"
	...
	req, _ := http.NewRequest("PUT", httpposturlCreate, bytes.NewBuffer(jsonCreateShop))
...
func TestUpdateShop2(t *testing.T){
